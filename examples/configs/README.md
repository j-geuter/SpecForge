...
| DFlash1 DPALA offline, colocated | [`offline/colocated/qwen3-4b-dflash-dpala-offline.yaml`](offline/colocated/qwen3-4b-dflash-dpala-offline.yaml) |
| DFlash1 DPAKL offline, colocated | [`offline/colocated/qwen3-4b-dflash-dpakl-offline.yaml`](offline/colocated/qwen3-4b-dflash-dpakl-offline.yaml) |
...
| DFlash1 DPALA | `training.loss_type: dpala`, `training.dpala_alpha` (`0.5`, in `[0, 1]`); negative-log overlap actor, detached overlap weights, final teacher states, and sequence-anchor reduction. |
| DFlash1 DPAKL | `training.loss_type: dpakl`, `training.dpakl_alpha` (`0.5`, in `[0, 1]`); forward KL(target‖draft) actor, detached overlap weights, final teacher states, and sequence-anchor reduction. |
| DFlash1 DPAKL-reverse | `training.loss_type: dpakl-reverse`, reuses `training.dpakl_alpha`; reverse KL(draft‖target) actor, otherwise identical to DPAKL. |
